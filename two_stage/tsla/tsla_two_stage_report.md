...
### Executive Summary
Tesla, Inc. is a leading Auto Manufacturers company headquartered in Austin, TX.
The company operates in the Consumer Cyclical sector and employs approximately 125,665 people globally
[Source: company_profile].

### Business Segments
The company operates through the following segments:
- **Auto Manufacturers - Core** (75% of revenue)
- **Services** (12% of revenue)
- **Accessories** (8% of revenue)
- **Other** (5% of revenue)

![Business Segment Revenue Distribution, pie chart showing segment breakdown](charts/segment_chart.png)
...
### Revenue Growth
Revenue has shown a 0.0% CAGR over the analyzed period, reaching $0.0B in 2020
[Source: income_statement].

![Revenue Growth Trend, bar chart with YoY growth annotations](charts/revenue_chart.png)

### Year-over-Year Performance

| Year | Revenue ($B) | Yoy Growth (%) |
|---|---|---|
| 2023 | 96.8 | <span class='trend-negative'>-0.9%</span> |
| 2022 | 81.5 | <span class='trend-negative'>-15.8%</span> |
| 2021 | 53.8 | <span class='trend-negative'>-33.9%</span> |
| 2020 | 0.0 | <span class='trend-negative'>-100.0%</span> |

### Net Income Trend
Net income reached $0.0B in 2020 (down from $5.5B in the prior year)
[Source: income_statement].

![Net Income Trend, bar chart showing profitability](charts/revenue_chart.png)
...
- Gross Margin: 25.3% (2022) → 0.0% (2024)
- Operating Margin: 12.1% (2022) → 0.0% (2024)
- Net Margin: 10.3% (2022) → 0.0% (2024)

[Source: profitability_metrics]

![Profitability Margins Comparison (2019-2024), grouped bar chart showing gross and operating margins](charts/margins_chart.png)
...
### Return on Equity
ROE has declined from a peak of 7.5% in 2022 to 0.0% in 2024, 
...
### Key Strengths:
1. **Net Cash Position**: $2.5B net cash
2. **Low Leverage**: D/E of 0.18x (minimal debt)
3. **Strong Liquidity**: Current ratio of 2.02x
...
![Annual Vehicle Deliveries (2019-2024), bar chart with trend line](charts/deliveries_chart.png)

### Delivery Trajectory

| Year | Deliveries (K) | Yoy Growth |
|---|---|---|
| 2023 | $96.8K | <span class='trend-negative'>-0.9%</span> |
| 2022 | $81.5K | <span class='trend-negative'>-15.8%</span> |
| 2021 | $53.8K | <span class='trend-negative'>-33.9%</span> |
| 2020 | $0.0 | <span class='trend-negative'>-100.0%</span> |
...
Tesla holds approximately 90% of the global EV market (among major players),
second to BYD at 1% [Source: competitor_data].

![Global EV Sales by Manufacturer (2024), bar chart comparing companies](charts/competitor_chart.png)

### Market Position

| Company | Ev Sales 2024 (K) | Market Cap ($B) | P/E Ratio |
|---|---|---|---|
| Tesla, Inc. | $1.6M | $1.6K | 323.26x |
| RIVN | $25.6K | $25.6 | 0.00x |
| F | $53.0K | $53.0 | 11.38x |

### Valuation Premium
Tesla trades at 323.25848x P/E vs. peer average of 7x,
reflecting growth expectations and technology leadership [Source: competitor_data].

![P/E Ratio Comparison, bar chart showing valuation premium](charts/competitor_chart.png)
...
- **32.3x** the industry average P/E (industry avg: 10x)
- **11.0x** the industry average P/S (industry avg: 1.5x)

### 52-Week Trading Range

- **52-Week High**: $498.83
- **52-Week Low**: $214.25
- **Current Price**: $475.19 (92% of range)
